...
* Mensaje de prueba `Probando servidor` en la terminal 3. Utilizar netcat o telnet para enviar mensajes y verificar la respuesta del servidor. Se debe ver tu mensaje enviado y la respuesta inmediata del servidor con el prefijo obligatorio [ECHO-SERVER] >.
![Mensaje de prueba 'Probando servidor'](./img/06.png)

### Paso 7: Prueba de cierre de conexion (Terminal 3 y 1)
* En la terminal 3 se envia 'salir'. En la terminal 1 se muestra el log que detecta y anuncia que el cliente se ha desconectado.
